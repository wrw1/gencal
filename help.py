""" help.py: Implement the Gencal help menu.
Contents are subject to revision at any time, without notice.

Help => Gencal Help: Display help.html with proper formatting.
...
show - Create HelpWindow.  Called in MainWindow.help_dialog.
"""
from html.parser import HTMLParser
from os.path import abspath, dirname, isdir, isfile, join
from tkinter import Tk, Toplevel, Frame, Text, Scrollbar, Menu, Menubutton, PhotoImage
...
class HelpParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag == 'div' and class_ == 'section':
            ...
            self.text.insert('end','\n')
            pic=PhotoImage(file=fn)
            box = ("{blue blue blue blue}")
            pic.put(box, to=(20,20,20,20))
            self.text.image_create('end', image=pic)
            s = '\n'
        elif tag == 'br':
            s='\n'
