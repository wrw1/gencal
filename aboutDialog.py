...
class AboutDialog(Toplevel):
    ...
    def __init__(self, parent, title='About Gencal', _htest=False,
...
#        self.link_cursor = ui.clickable_cursor
    ...
    def CreateWidgets(self):
        ...
        labelTitle = Label(frameBg, text='Gencal ' + G.Version, fg=self.fg, bg=self.bg,
    ...
    def load_moreinfo(self):
        self.info = []
        self.load_from_file('Gencal Readme', 'README.txt')
        self.load_from_file('Gencal News', 'NEWS.txt')
        self.load_from_file('Gencal ToDo', 'TODO.txt')
        self.load_from_file('Gencal Credits', 'CREDITS.txt')
